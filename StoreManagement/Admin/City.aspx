    ...
    <div style="width: 100%">
        <div>
            <table style="width: 100%">
                <tr> 
                    <td align="left"><h3 style="color:#2679b5;">City</h3></td>
...
<asp:Content ID="cnt2" ContentPlaceHolderID="cphData" runat="server">
    ...
    <ContentTemplate>
       ...
       <asp:GridView ID="dgvCity" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="table table-striped table-bordered table-hover" DataKeyNames="CityID">
                                    <Columns>
