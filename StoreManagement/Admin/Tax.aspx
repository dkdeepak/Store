   ...
   <div style="width: 100%">
        <div>
            <table style="width: 100%">
                <tr > 
                    <td align="left"><h3 style="color:#2679b5;">Tax</h3></td>
    ...
    <asp:UpdatePanel ID="updateTax" runat="server" UpdateMode="Conditional">
        ...
        <ajaxToolkit:AccordionPane ID="acdFaq2" runat="server">
            ...
            <Content>--%>
                                ...
                                <asp:GridView ID="dgvTax" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="table table-striped table-bordered table-hover" DataKeyNames="TaxID">
                                    <Columns>
