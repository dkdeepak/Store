<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SalesReturn.aspx.cs" Inherits="StoreManagement.SalesReturn" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContain" runat="server">
   ...
   <ContentTemplate>
       ...
       <div class="row" id="divData" runat="server">
           <asp:GridView ID="gvSaleRtn" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDeleting="gvSaleRtn_RowDeleting">
               <Columns>
                    <asp:BoundField HeaderText="Vendor Name" ItemStyle-CssClass="text_title" DataField="VendorName" ItemStyle-Width="5%" />
                    <asp:BoundField HeaderText="Sales Return Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-CssClass="text_title" DataField="SalesReturnDate" ItemStyle-Width="5%" />
                    <asp:BoundField HeaderText="Total Sales Return Amount" ItemStyle-CssClass="text_title" DataField="TotalSalesReturnAmount" ItemStyle-Width="5%" />
                    <asp:BoundField HeaderText="Tax" ItemStyle-CssClass="text_title" DataField="TaxValue" ItemStyle-Width="5%" />
                    <asp:BoundField HeaderText="Shiping & Handling" ItemStyle-CssClass="text_title" DataField="ShippingAndHandlingCost" ItemStyle-Width="5%" />
                    <asp:BoundField HeaderText="Miscellaneous Cost" ItemStyle-CssClass="text_title" DataField="MiscCost" ItemStyle-Width="5%" />
                    <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="5%">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hfSaleRtnId" Value='<%# Bind("SalesReturnedID") %>' runat="server" />
       ...
       <hr />
       <asp:HiddenField ID="hfSaleOrder" runat="server" />
        <asp:gridview ID="Gridview1" runat="server" ShowFooter="true"  CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false"  GridLines="None" OnRowDataBound="Gridview1_RowDataBound">
            ...
            <asp:TemplateField HeaderText="sale Price">
                <ItemTemplate>
                    <asp:TextBox ID="txtSPrice"  Text='<%# Bind("ItemSalePricePerUnit") %>' ReadOnly="true"  placeholder="sale Price" ToolTip="sale Price"    runat="server" CssClass="form-control"></asp:TextBox>
                </ItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtSPriceT" placeholder="00.00" ToolTip="sale Price"  ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                </FooterTemplate>
            </asp:TemplateField>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-default">
                    <div class="panel-heading">
                        <table width="100%">
                                <tr>
                                    <td align="left"><b>Sales Return Summary</b></td>
                     ...
                     <div class="panel-body">
                         ...
                         <div class="row">
                             <div class="col-lg-6"><label class="form-control">Shipping & Handling Cost</label></div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-4 ">
                                 <asp:Button ID="btnCancelsaleRtn" runat="server" Text="Cancel" CssClass="form-control btn-danger" OnClick="btnCancelsaleRtn_Click" />
                             </div>
                         </div>
                    </div>
                </div>
